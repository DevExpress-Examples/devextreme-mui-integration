...
function Process-Project {
    ...
    Write-Output "`n--== Starting MUI Integration Project Processing ==--"

    # The project lives in the repository root
    $folderName = "devextreme-mui-integration"
    ...
    Write-Output "`n--== MUI Integration Project Processing Completed ==--"
}
